    ...
    public function getTagView(){
        ...
        if (is_array($this->tags))
            foreach ($this->tags as $key => $value) {
                foreach ($value as $key_gr => $name) {
                    $data[$key][]=array('id'=>$key_gr,'text'=>$name);    
                }
    ...
    public function run()
    {
        ...
        foreach ($this->gallery->galleryPhotos as $photo) {
            $photos[] = array(
                ...
                'main' => $photo->main,
                'tags'=>$this->tags ? $photo->tags : false,
            );
        }
        ...
        $opts = array(
            ...
            'changeMainUrl' => Yii::app()->createUrl($this->controllerRoute . '/changeMain'),
