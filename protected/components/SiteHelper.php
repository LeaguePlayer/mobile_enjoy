...
class SiteHelper {
	...
	public static function send_mail($subject, $msg,  $email,  $from, $file)
    {
        ...
        foreach ($file as $key => $value) {
           ...
           $ftype='image/'.$info['basename'];
           $message_part .= "Content-Type: ".$ftype."\n";
           $message_part .= "Content-Transfer-Encoding: base64\n";
           $message_part .= "Content-Disposition: attachment; filename=\"".$info['basename']."\"\n\n";
           $message_part .= chunk_split(base64_encode($file)) . "\n";
        }
        $multipart .= $message_part . "--$boundary--\n";

        return mail($email, $subject, $multipart, $headers);
    }
